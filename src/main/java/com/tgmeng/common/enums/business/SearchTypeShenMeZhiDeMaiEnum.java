...
@Getter
@AllArgsConstructor
public enum SearchTypeShenMeZhiDeMaiEnum implements INameValueEnum<String,String> {
    LI_SHI_DI_JIA_SHEN_ME_ZHI_DE_MAI("LI_SHI_DI_JIA_SHEN_ME_ZHI_DE_MAI", "h0s0t14995f0c0p1", "历史低价 什么值得买", true,2);
