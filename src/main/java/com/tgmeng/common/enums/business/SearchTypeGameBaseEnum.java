...
@Getter
@AllArgsConstructor
public enum SearchTypeGameBaseEnum implements INameValueEnum<String,String> {
    PC("shoujiyouxi", "mobile", "手機遊戲", true,1),
    XBOX("pc", "pc", "pc", true,2),
    NDS("tvzhangji", "console", "tv掌机", true,4);
