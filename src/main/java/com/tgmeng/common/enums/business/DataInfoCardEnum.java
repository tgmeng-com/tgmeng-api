...
public enum DataInfoCardEnum implements INameValueEnum<String,String> {
    ...
    GITHUB_ALL_STAR("GitHub Star总榜", "../../assets/logos/tgmeng-trend_.png", "all", true,5),
    GITHUB_DAY_STAR("近一日新仓库Star榜", "../../assets/logos/tgmeng-trend_.png", "day", true,5),
    GITHUB_WEEK_STAR("近一周新仓库Star榜", "../../assets/logos/tgmeng-trend_.png", "week", true,5),
    GITHUB_MONTH_STAR("近一月新仓库Star榜", "../../assets/logos/tgmeng-trend_.png", "month", true,5),
    GITHUB_YEAR_STAR("近一年新仓库Star榜", "../../assets/logos/tgmeng-trend_.png", "year", true,5),
    GITHUB_THREE_YEAR_STAR("近三年新仓库Star榜", "../../assets/logos/tgmeng-trend_.png", "threeyear", true,5),
    GITHUB_FIVE_YEAR_STAR("近五年新仓库Star榜", "../../assets/logos/tgmeng-trend_.png", "fiveyear", true,5),
    GITHUB_TEN_YEAR_STAR("近十年新仓库Star榜", "../../assets/logos/tgmeng-trend_.png", "tenyear", true,5),
