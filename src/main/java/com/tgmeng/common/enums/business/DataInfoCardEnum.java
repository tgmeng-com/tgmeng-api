...
public enum DataInfoCardEnum implements INameValueEnum<String,String> {
    BILIBILI("B站", "../../assets/logos/tgmeng-trend_bilibili.png", "媒体", true,1),
    BAIDU("百度", "../../assets/logos/tgmeng-trend_baidu.png", "新闻", true,2),
    WEIBO("微博", "../../assets/logos/tgmeng-trend_.png", "社交", true,3),
    DOU_YIN("抖音", "../../assets/logos/tgmeng-trend_douyin.png", "媒体", true,4),
    GITHUB_ALL_STAR("GitHub Star总榜", "../../assets/logos/tgmeng-trend_.png", "GitHub", true,5),
    GITHUB_DAY_STAR("近一日新仓库Star榜", "../../assets/logos/tgmeng-trend_.png", "GitHub", true,5),
    GITHUB_WEEK_STAR("近一周新仓库Star榜", "../../assets/logos/tgmeng-trend_.png", "GitHub", true,5),
    GITHUB_MONTH_STAR("近一月新仓库Star榜", "../../assets/logos/tgmeng-trend_.png", "GitHub", true,5),
    GITHUB_YEAR_STAR("近一年新仓库Star榜", "../../assets/logos/tgmeng-trend_.png", "GitHub", true,5),
    GITHUB_THREE_YEAR_STAR("近三年新仓库Star榜", "../../assets/logos/tgmeng-trend_.png", "GitHub", true,5),
    GITHUB_FIVE_YEAR_STAR("近五年新仓库Star榜", "../../assets/logos/tgmeng-trend_.png", "GitHub", true,5),
    GITHUB_TEN_YEAR_STAR("近十年新仓库Star榜", "../../assets/logos/tgmeng-trend_.png", "GitHub", true,5),
    ...
    CCTV("CCTV", "https://r2-trend.tgmeng.com/tgmeng-trend/she-ji-da-ren.png", "电视", true,5),
    PENG_PAI_XIN_WEN("澎湃新闻", "https://r2-trend.tgmeng.com/tgmeng-trend/she-ji-da-ren.png", "新闻", true,5);
