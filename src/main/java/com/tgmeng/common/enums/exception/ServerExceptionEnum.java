...
public enum ServerExceptionEnum implements INameValueEnum<Integer, String> {
    ...
    WANGYI_TOP_SEARCH_EXCEPTION(106, "网易新闻热搜接口查询异常", "有可能是网络问题、风控(速率等)、接口变更、数据结构变更等", true, 1),
    WANGYIYUN_TOP_SEARCH_EXCEPTION(106, "网易云新闻热搜接口查询异常", "有可能是网络问题、风控(速率等)、接口变更、数据结构变更等", true, 1);
