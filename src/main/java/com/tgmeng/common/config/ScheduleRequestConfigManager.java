...
public class ScheduleRequestConfigManager {
    ...
    private void initConfigs() {
        ...
        configs.put("/api/cachesearch/realtimesummary/all", PlatformConfig.builder().requestCycle(300L).timeout(300L).build());
        configs.put("/api/cachesearch/realtimesummary/news", PlatformConfig.builder().requestCycle(300L).timeout(300L).build());
        configs.put("/api/cachesearch/realtimesummary/wool", PlatformConfig.builder().requestCycle(300L).timeout(300L).build());
        configs.put("/api/cachesearch/realtimesummary/media", PlatformConfig.builder().requestCycle(300L).timeout(300L).build());
        configs.put("/api/cachesearch/realtimesummary/tv", PlatformConfig.builder().requestCycle(300L).timeout(300L).build());
        configs.put("/api/cachesearch/realtimesummary/life", PlatformConfig.builder().requestCycle(300L).timeout(300L).build());
        configs.put("/api/cachesearch/realtimesummary/community", PlatformConfig.builder().requestCycle(300L).timeout(300L).build());
        configs.put("/api/cachesearch/realtimesummary/finance", PlatformConfig.builder().requestCycle(300L).timeout(300L).build());
        configs.put("/api/cachesearch/realtimesummary/sports", PlatformConfig.builder().requestCycle(300L).timeout(300L).build());
        configs.put("/api/cachesearch/realtimesummary/technology", PlatformConfig.builder().requestCycle(300L).timeout(300L).build());
        configs.put("/api/cachesearch/realtimesummary/design", PlatformConfig.builder().requestCycle(300L).timeout(300L).build());
        configs.put("/api/cachesearch/realtimesummary/audiovideo", PlatformConfig.builder().requestCycle(300L).timeout(300L).build());
        ...
        configs.put("/api/topsearch/36ke", PlatformConfig.builder().build());
        configs.put("/api/topsearch/itzhijia", PlatformConfig.builder().build());
        configs.put("/api/topsearch/readhub", PlatformConfig.builder().build());
        configs.put("/api/topsearch/taimeiti", PlatformConfig.builder().build());
        configs.put("/api/topsearch/zhongguancunzaixian", PlatformConfig.builder().build());
        configs.put("/api/topsearch/landianwang", PlatformConfig.builder().build());
        configs.put("/api/topsearch/chuangyebang", PlatformConfig.builder().build());
        ...
        configs.put("/api/topsearch/schedule/tonghuashun/remenhuati", PlatformConfig.builder().build());
        configs.put("/api/topsearch/schedule/tonghuashun/remenwenzhang", PlatformConfig.builder().build());
        configs.put("/api/topsearch/schedule/tonghuashun/kuaixunzhongyao", PlatformConfig.builder().build());
        configs.put("/api/topsearch/schedule/tonghuashun/toutiao", PlatformConfig.builder().build());
