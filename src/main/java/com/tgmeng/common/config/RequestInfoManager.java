...
public class RequestInfoManager {
    ...
    private static class FluentConfig {
        ...
        public FluentConfig platformCategoryRoot(String v) {
            config.platformCategoryRoot(v);
            return this;
        }
    ...
    private void initConfigs() {
        ...
        addJsonConfig("https://cache.thepaper.cn/contentapi/wwwIndex/rightSidebar")
                .requestType(ForestRequestTypeEnum.GET)
                .platformName("澎湃新闻")
                .platformCategory(PlatFormCategoryRootEnum.XIN_WEN.getValue())
                .platformCategoryRoot(PlatFormCategoryRootEnum.XIN_WEN.getValue())
        ...
        addDomConfig("https://www.jksb.com.cn/newslist/posid/8")
                .requestType(ForestRequestTypeEnum.GET)
                .platformName("健康时报网")
                .platformCategory(PlatFormCategoryRootEnum.JIAN_KANG.getValue())
                .platformCategoryRoot(PlatFormCategoryRootEnum.JIAN_KANG.getValue())
        ...
        addDomConfig("https://www.ali213.net/")
                .requestType(ForestRequestTypeEnum.GET)
                .platformName("游侠网")
                .platformCategory(PlatFormCategoryRootEnum.YOU_XI.getValue())
                .platformCategoryRoot(PlatFormCategoryRootEnum.YOU_XI.getValue())
        ...
        addDomConfig("https://www.zhibo8.com/")
                .requestType(ForestRequestTypeEnum.GET)
                .platformName("直播吧")
                .platformCategory(PlatFormCategoryRootEnum.TI_YU.getValue())
                .platformCategoryRoot(PlatFormCategoryRootEnum.TI_YU.getValue())
        ...
        addJsonConfig("https://www.jiqizhixin.com/api/article_library/articles.json?sort=time&page=1&per=12")
                .requestType(ForestRequestTypeEnum.GET)
                .platformName("机器之心")
                .platformCategory(PlatFormCategoryRootEnum.KE_JI.getValue())
                .platformCategoryRoot(PlatFormCategoryRootEnum.KE_JI.getValue())
        ...
        addDomConfig("https://abduzeedo.com/")
                ...
                .platformCategory(PlatFormCategoryRootEnum.SHE_JI.getValue())
                .platformCategoryRoot(PlatFormCategoryRootEnum.SHE_JI.getValue())
        ...
        addJsonConfig("https://dq.10jqka.com.cn/fuyao/hot_list_data/out/hot_list/v1/topic?page=1&page_size=30")
                ...
                .platformCategory(PlatFormCategoryEnum.TONG_HUA_SHUN.getValue())
                .platformCategoryRoot(PlatFormCategoryRootEnum.CAI_JING.getValue())
                .interfaceUrl("/api/topsearch/schedule/tonghuashun/remenhuati")
                .hotTitleUrlPrefix("")
                .addArea()
        ...
        addJsonConfig("https://ai.iwencai.com/index/urp/getdata/basic?tag=%E5%90%8C%E8%8A%B1%E9%A1%BA%E7%83%AD%E6%A6%9C_%E6%96%B0%E7%83%AD%E6%96%87")
                ...
                .platformCategory(PlatFormCategoryEnum.TONG_HUA_SHUN.getValue())
                .platformCategoryRoot(PlatFormCategoryRootEnum.CAI_JING.getValue())
                .interfaceUrl("/api/topsearch/schedule/tonghuashun/remenwenzhang")
                .hotTitleUrlPrefix("")
                .addArea()
        ...
        addDomConfig("https://www.10jqka.com.cn/")
                ...
                .platformCategory(PlatFormCategoryEnum.TONG_HUA_SHUN.getValue())
                .platformCategoryRoot(PlatFormCategoryRootEnum.CAI_JING.getValue())
                .interfaceUrl("/api/topsearch/schedule/tonghuashun/toutiao")
                .hotTitleUrlPrefix("")
                .addArea()
        ...
        addJsonConfig("https://www-hj.douyin.com/aweme/v1/web/hot/search/list/")
                ...
                .platformCategoryRoot(PlatFormCategoryRootEnum.MEI_TI.getValue())
        ...
        addJsonConfig("https://music.163.com/api/playlist/detail?id={type}")
                ...
                .platformCategoryRoot(PlatFormCategoryRootEnum.YING_YIN.getValue())
        ...
        addDomConfig("https://www.douban.com/group/{type}")
                ...
                .platformCategoryRoot(PlatFormCategoryRootEnum.SHENG_HUO.getValue())
        ...
        addJsonConfig("https://api.cntv.cn/epg/getEpgInfoByChannelNew?c=cctv{type}&serviceId=tvcctv&d={time}&t=jsonp&cb=setItem1")
                ...
                .platformCategoryRoot(PlatFormCategoryRootEnum.DIAN_SHI.getValue())
        ...
        addDomConfig("http://www.0818tuan.com/")
                ...
                .hotTitleNeedDeal(true)
                .platformName("0818团")
                .platformCategory(PlatFormCategoryRootEnum.YANG_MAO.getValue())
                .platformCategoryRoot(PlatFormCategoryRootEnum.YANG_MAO.getValue())
