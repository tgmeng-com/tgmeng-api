...
public interface ITopSearchGithubClient {
    ...
    @Get("https://api.github.com/search/repositories?q=stars:%3E50000&sort=stars&order=desc&page=1&per_page=100")
    TopSearchGitHubDTO allStars(@Header ForestRequestHeader topSearchRequestHeader);
}
