package com.tgmeng.common.forest.httptype;
...
@Getter
@AllArgsConstructor
public enum ForestRequestTypeEnum implements INameValueEnum<String,String> {
    GET("GET", "GET", "GET请求", true,1),
    POST("POST", "POST", "POST请求", true,2);
